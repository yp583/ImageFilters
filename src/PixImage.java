...
public class PixImage {
    ...
    public PixImage(String imageFileName) {
        ...
        if (!originalImage.getColorModel().equals(BufferedImage.TYPE_INT_RGB)) {
            BufferedImage rgbImg = new BufferedImage(originalImage.getWidth(), originalImage.getHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    public void showImage() {
        ...
        JScrollPane scroller = new JScrollPane(labelImage, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
